...
TMP_FILE=$(mktemp)
wget -q -O "$TMP_FILE" https://fw0.koolcenter.com/iStoreOS/ib/armsr/

# 使用 grep 提取所有 img.gz 文件的链接
LATEST_URL=$(grep -o 'istoreos-[0-9.]*-[0-9]*-armsr-armv8.Linux-x86_64.tar.zst' "$TMP_FILE" | head -n 1)
...
# FULL_URL="https://fw0.koolcenter.com/iStoreOS/ib/armsr/$LATEST_URL"
FULL_URL="https://fw0.koolcenter.com/iStoreOS/ib/armsr/$LATEST_URL"
...
if [ -f "$README_FILE" ]; then
    ...
    CURRENT_URL=$(grep -o 'https://fw0.koolcenter.com/iStoreOS/ib/armsr/istoreos-[0-9.]*-[0-9]*-armsr-armv8.Linux-x86_64.tar.zst' "$README_FILE" | head -n 1)
